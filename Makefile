...
ifeq ($(OS),osx)
	CXXLIBS += -framework OpenGL -framework IOKit -framework Cocoa -framework CoreVideo -framework ApplicationServices -framework CoreFoundation -framework QuartzCore
