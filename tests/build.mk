...
http.libs-$(win) += -lws2_32 -static-libgcc -static-libstdc++
...
TEST_TESTS += ./tests/bin/$(1)_test$(EXTENSION)
tests/bin/$(1)_test$(EXTENSION): $$(TEST_DEF_OBJS) $$($(1).src-y) $$($(1).exe-libs-y) | tests/bin
