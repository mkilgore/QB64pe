...
int assert_buffers_equal_with_name(const char *name, const char *func, const char *arg1, const char *buf1, const char *arg2, const char *buf2, size_t length)
{
    ...
    int ret = assert_true(buf, func, result == 0);
...
int assert_ints_equal_with_name(const char *name, const char *func, const char *arg1, uint64_t int1, const char *arg2, uint64_t int2)
{
    ...
    int ret = assert_true(buf, func, result);
